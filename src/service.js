...
// const getActivityService = ({tenantId,cursor,limit})=>{
...
// return ActivityModel.find(query).sort({createdAt:-1}).select("tenantId actor activity createdAt").limit(Number(20))
